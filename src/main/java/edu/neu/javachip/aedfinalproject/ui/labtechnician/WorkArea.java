...
public class WorkArea extends AnchorPane {
    ...
    WorkArea(Dashboard dashboard) {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(ViewFXMLs.LAB_TECHS_VIEWS.WORK_AREA.getValue()));
    ...
    private void processRequest(){
        ...
        parentController.openRequestForProcessing((LabTestWorkRequest) tblMyWorkQueue.getSelectionModel().getSelectedItem());
    }
