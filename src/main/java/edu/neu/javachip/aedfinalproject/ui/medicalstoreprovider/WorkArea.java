...
public class WorkArea extends AnchorPane {
    ...
    WorkArea(Dashboard dashboard) {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(ViewFXMLs.MEDICAL_STORE_PROVIDER_VIEWS.WORK_AREA.getValue()));
    ...
    private void processRequest(){
        ...
        parentController.openRequestForProcessing((ProvideMedicalItemsWorkRequest) tblMyWorkQueue.getSelectionModel().getSelectedItem());
    }
